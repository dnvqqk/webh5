    ...
    WLoader.checkNext = function () {
        ...
        while (WLoader._startIndex < WLoader._loaders.length) {
            ...
            if (Date.now() - startTimer > WLoader.maxTimeOut) {
                ...
                setInterval(WLoader.checkNext,1);
...
var MainJs = /** @class */ (function () {
    function MainJs() {
        ...
        load.load("version.json"+window["wmyVTime"], "json");
    ...
    MainJs.JssArr = function () {
        var jsUrlArr = [];
        jsUrlArr.push("https://res.imtt.qq.com/common/zepto.min.js");
        jsUrlArr.push("libs/laya.core.js");
        jsUrlArr.push("libs/laya.webgl.js");
        jsUrlArr.push("libs/laya.d3.js");
        jsUrlArr.push("libs/laya.physics3D.js");
	...
	MainJs.jsLoad = function () {
		...
		if (MainJs.num < MainJs.totalNum) {
            ...
            var load = new Loader_1.WLoader();
            load.load(urlJs,"text");
            load.on("error", this, MainJs.loadError);
            load.on("complete", this, function (d){
			...
			MainJs.html["innerText"] = "";
        }
	}
	
	MainJs.loadJs = function (jsArr, fun) {
        if (jsArr.length > 0) {
            requirejs(jsArr, fun, MainJs.loadError);
        }
    };
    
	MainJs.loadError = function (e) {
        if (MainJs.html != null && MainJs.html["innerText"] != null) {
